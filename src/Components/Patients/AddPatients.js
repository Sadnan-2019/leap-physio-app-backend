    ...
    return (
      ...
      <div class="col-lg-6 d-flex justify-content-between align-items-center p-2   ">
            <div class="form-group p-2 col-lg-6 "  >
              ...
              <input class="form-control select2" style={{ width: "100%" }} placeholder="Patients Name"/>
                
            </div>
            <div class="form-group p-2 col-lg-6 "  >
              <label>Patients Attendent Name</label>
              <input class="form-control select2" style={{ width: "100%" }} placeholder="Patients Attendent Name"/>
                
            </div>
            <div class="form-group p-2 col-lg-6 "  >
              <label>Patients  Mobile Number </label>
              <input class="form-control select2" style={{ width: "100%" }} placeholder="Patients  Mobile "/>
      ...
      <div class="col-lg-6 d-flex justify-content-between align-items-center p-2   ">
            <div class="form-group p-2 col-lg-6 "  >
              <label>Age</label>
              <input class="form-control select2"   placeholder="Patients  Age "/>
            ...
            <div class="form-group p-2 col-lg-6  "  >
              ...
              <input class="form-control select2"   placeholder="Patients Attendent Moile No"/>
